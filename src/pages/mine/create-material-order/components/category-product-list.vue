...
import { getCommodityConfigListService } from '../service'
...
// 加载商品数据
const loadProducts = async (categoryId?: number | null): Promise<void> => {
  loading.value = true
  products.value = []
  ...
  try {
    ...
    const { success, data } = await getCommodityConfigListService(params)
