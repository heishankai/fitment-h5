...
import { getWechatUserRooms, deleteRoom } from '../service'
...
const handleClick = (item: any) => {
  router.push({
    path: `/chat/wechat/${item.id}`,
    query: {
      craftsmanUserId: item.craftsman_user_id,
      craftsmanUserName: item.craftsman_user?.nickname
    }
  })
}
